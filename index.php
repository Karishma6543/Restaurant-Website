		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> K'S KITCHEN</strong></h1>
							<p class="m-b-40">Have It Your Way,   <br> 
							Don't have time to visit us?
Then just order now and enjoy your food at home!</p>
			...
			<li class="text-left">
				<img src="images/1-Gujarathi-restaurants-1-ki1aq.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>We like  <br> to eat well.</strong></h1>
							<p class="m-b-40">K's Kitchen is serving a Authentic Food.And Restaurant's 
<br> 
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> have a great food with K's</strong></h1>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						...
						<h4>Little Story</h4>
						<p>Restaurants in Mumbai, Mumbai Restaurants, Mumbai restaurants, Best Mumbai restaurants, West Mumbai restaurants, Gujarati Restaurants in Mumbai, Gujarati near me, Gujarati Restaurants in West Mumbai, 
Gujarati Restaurants in Mumbai, 
 </p>
						<p>Quick Bites in Mumbai, Quick Bites near me, Quick Bites in West Mumbai, Quick Bites in Mumbai, in Mumbai, near me, in West Mumbai, in Mumbai, in Mumbai, near me, in West Mumbai, in Mumbai, New Year Parties in Mumbai, Christmas' Special in Mumbai,</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">K's Kitchen</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for K's Kitchen Listed Here </p>
					</div>
				</div>
			</div>
